...
First, you can define the signal and background dataset IDs (DSIDs). An overview of the available 13 TeV 2025 data can be found [here](https://opendata.atlas.cern/docs/data/for_education/13TeV25_metadata/#). 
